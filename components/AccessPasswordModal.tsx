...
const AccessPasswordModal: React.FC<AccessPasswordModalProps> = ({ onVerify, onClose }) => {
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-8 w-full max-w-sm" onClick={e => e.stopPropagation()}>
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                        Para acessar esta seção, por favor, insira a senha.
                    </p>
                </div>
                <form onSubmit={handleSubmit} className="mt-6">
                    <div>
                        <label htmlFor="access-password" className="sr-only">Senha</label>
                        <input
                            type="password"
