    ...
    return (
        ...
        >
            <div className="flex justify-between items-start">
                <div className="flex items-center justify-center h-8 w-8 rounded-xl bg-orange-500">
                    <AssignmentsIcon className="h-5 w-5 text-white" />
                </div>
                <div className="text-right">
                    <h3 className="text-xs font-bold text-slate-900 dark:text-white">Designações</h3>
                    <p className="text-[10px] font-semibold text-orange-600 dark:text-orange-400">{formattedDate}</p>
                </div>
            </div>
                ...
                {schedule.president && (
                 ...
                 {schedule.reader && (
                    <div className="flex items-center gap-1.5">
                        ...
                        <p className="text-[10px] font-semibold text-slate-800 dark:text-slate-200 truncate">Leitor: {schedule.reader}</p>
                    </div>
                )}
            </div>
