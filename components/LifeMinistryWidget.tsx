    ...
    return (
        ...
        >
            <div className="flex justify-between items-start">
                <div className="flex items-center justify-center h-9 w-9 rounded-xl bg-green-500 shrink-0">
                    <LifeMinistryIcon className="h-6 w-6 text-white" />
                </div>
                <div className="text-right">
                    <h3 className="text-sm font-bold text-slate-900 dark:text-white">Vida e Ministério</h3>
                    <p className="text-xs font-semibold text-green-600 dark:text-green-400">{formattedDate}</p>
                </div>
            </div>
            ...
            <div className="mt-2 space-y-1">
                <div className="flex items-center gap-2">
                 ...
                 <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">Leitura: {schedule.bibleReading.student}</p>
                </div>
            </div>
